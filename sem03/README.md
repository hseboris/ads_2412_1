...
Задача на поиск [длины кратчайшего пути](https://informatics.msk.ru/mod/statements/view.php?chapterid=111649)
```cpp
#include <bits/stdc++.h>
using namespace std;
...
Задача [путь спелеолога](https://informatics.msk.ru/mod/statements/view.php?chapterid=669)
